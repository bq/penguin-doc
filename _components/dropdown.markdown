...
You can easily add CSS3 transition to sropdown when appears and disappears on the screen. You can do it through **transition class**. Check the next example:
...
.dropdown__menu {
  ...
  @include transition(opacity, translate, .3s);
